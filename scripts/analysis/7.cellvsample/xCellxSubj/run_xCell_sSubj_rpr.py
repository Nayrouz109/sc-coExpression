...
from lnk_fisher import process_lnktbles, compute_fisher_XcellXsubj
...
#    --lnk_output_dir    '/cosmos/data/project-data/NW-rewiring/coExpr/xCellxSubject/rpr/lnkTables' \
#    --fisher_output_dir "/cosmos/data/project-data/NW-rewiring/coExpr/xCellxSubject/rpr/fisher" \
#    --cell_types Mic Oli Opc Exc Inh Ast \
#    --cell_types Mic  \
#    --condition CTL
#    --n_jobs 4
...
#    --lnk_output_dir    '/cosmos/data/project-data/NW-rewiring/coExpr/0all/rpr/lnkTables' \
#    --fisher_output_dir "/cosmos/data/project-data/NW-rewiring/coExpr/0all/rpr/fisher" \
#    --cell_types Mic Oli Opc Exc Inh Ast \
#    --condition CTL
...
#    --lnk_output_dir    '/cosmos/data/project-data/NW-rewiring/coExpr/xSubject/rpr/lnkTables' \
#    --fisher_output_dir "/cosmos/data/project-data/NW-rewiring/coExpr/xSubject/rpr/fisher" \
#    --cell_types Mic Oli Opc Exc Inh Ast \
#    --condition CTL
