...
def main():
    ...
    for file_name in os.listdir(args.input_dir):
        if file_name.endswith(".h5ad") and file_name.startswith("Ast"):
...
#python h5ad_to_edgeList_out.py /cosmos/data/project-data/NW-rewiring/coExpr/disease/agg-mtx /cosmos/data/project-data/NW-rewiring/coExpr/disease/edge-list/all-matrix
