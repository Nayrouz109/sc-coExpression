...
dir = "/cosmos/data/downloaded-data/AD-meta/ROSMAP-erosion/data/0-source/expr/cell-type-rds" 
out = "/cosmos/data/downloaded-data/AD-meta/ROSMAP-erosion/data/0-source/expr/rds-comps/"
...
for (file in files) {
    ...
    name   = paste0(name0, "_ROSMAP-erosion-2023") 
