...
dir = "/cosmos/data/downloaded-data/AD-meta/ROSMAP-TREM2/data/1-filt/raw" 
out = "/cosmos/data/downloaded-data/AD-meta/ROSMAP-TREM2/data/1-filt/rds-comps/"
...
for (file in files) {
    ...
    name   = paste0(name0, "_ROSMAP-TREM2-2020") 
