...
# the tow patterns were used/extracted one at a time - total raw/messy counts used was 87 
# origianl authors data is found here: space/scratch/nairuz-rewiring-normal/data/raw/ling/counts/counts-messy 