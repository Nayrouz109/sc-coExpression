...
input_dir = '/cosmos/data/downloaded-data/AD-meta/SEA-AD-DLPFC/data/0-source/expr/SEAAD_A9_RNAseq_final-nuclei.2024-02-13.h5ad'
...
for cell_type, condition in cell_types.items():
    ...
    file_name = f"{cell_type}_SEA-AD-DLPFC-2024.h5ad"  
