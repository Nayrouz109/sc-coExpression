...
path  = "/cosmos/data/downloaded-data/AD-meta/ruzika-2024/rds-cmps"
output_dir = "/space/scratch/nairuz-rewiring/data/0.prcsd-raw"

all_files = sorted(os.listdir(path))
mssm_files = [file for file in all_files if "MSSM" in file]


#for prefix in set(f.split("_")[0] + "_" + f.split("_")[1] for f in all_files):
for prefix in set(f.split("_")[0] + "_" + f.split("_")[1] for f in mssm_files):
