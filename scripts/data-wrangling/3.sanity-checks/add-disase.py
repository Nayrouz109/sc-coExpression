...
#input_dir  = Path("/cosmos/data/project-data/NW-rewiring/data/1.prcsd-clean")              #feb 14th 
#output_dir = Path("/cosmos/data/project-data/NW-rewiring/data/1.prcsd-clean/diag-disease") #feb 14th 
#output_dir.mkdir(parents=True, exist_ok=True)

input_dir  = Path("/cosmos/data/project-data/NW-rewiring/data/3.prcsd-slcGenes/allCells") #sep 24th 
output_dir = Path("/cosmos/data/project-data/NW-rewiring/data/3.prcsd-slcGenes/raw")      #sep 24th 
output_dir.mkdir(parents=True, exist_ok=True)
...
for file_path in input_dir.glob("*.h5ad"):
    ...
    adata.obs = adata.obs.merge(
        p_meta_study[["patientID","diagnosis" , "disease"]], 
        on="patientID", 
        how="left") 
